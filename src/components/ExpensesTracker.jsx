...
export default function ExpensesTracker({ 
  ...
  const budgetLimit = config?.monthlyBudget || 3500000; // Adjusted budget limit dynamically
    ...
    <div className="tab-pane active">
      ...
      <div className="top-header">
        <div className="header-title-area">
          <h1>Control de Asistencia (Gastos)</h1>
          <p>Lleva las cuentas claras del mes. ¡El inge te ayuda a organizarte! 🍁🍂</p>
        </div>
      </div>
      ...
      <div className="glass-card" style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
          <div>
            <span style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Presupuesto Mensual del Salón</span>
        ...
        {budgetPercentage >= 90 && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--accent-rose)', fontSize: '0.85rem', marginTop: '0.5rem' }}>
            <AlertCircle size={16} />
            <span>Alerta de Clases: Hemos consumido casi el 100% de los ingresos de este mes, profe. 🛑</span>
          </div>
        )}
      </div>
      ...
      <div className="glass-card" style={{ marginBottom: '2rem' }}>
              ...
              {(!obligations || obligations.length === 0) && (
                <tr>
                  <td colSpan="6" style={{ textAlign: 'center', padding: '2rem', color: 'var(--text-muted)' }}>
                    No tienes obligaciones recurrentes registradas. Agrega una abajo.
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '1.25rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
          <h3 style={{ fontSize: '1rem', marginBottom: '0.75rem' }}>Agregar Obligación Recurrente</h3>
          <form onSubmit={handleAddObligationSubmit} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr)) auto', gap: '0.75rem', alignItems: 'end' }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input 
                type="text" 
                placeholder="Ej. Plan de Teléfono" 
                value={newOblDesc} 
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <select 
                ...
                style={{ padding: '0.55rem 0.75rem', fontSize: '0.85rem' }}
              >
                <option value="Gasto Fijo">Contrato Fijo</option>
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              <label style={{ fontSize: '0.75rem' }}>Día Vencimiento</label>
              <input 
                type="text" 
                placeholder="Ej. Día 10" 
                value={newOblDueDate} 
      ...
      <div className="grid-cols-2">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div className="glass-card">
            ...
            <h2>{formTab === 'expense' ? 'Registrar Gasto Escolar/Ocio' : 'Registrar Nuevo Ingreso'}</h2>
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <input 
                  ...
                  placeholder={formTab === 'expense' ? "Ej. Materiales para el salón..." : "Ej. Pago Asesoría Particular..."} 
                  required
                />
              </div>
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          {chartData.length === 0 ? (
            <div style={{ flexGrow: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', height: '300px' }}>
              <p style={{ color: 'var(--text-muted)' }}>Registra gastos para ver tu distribución gráfica. 🍁</p>
            </div>
          ) : (
