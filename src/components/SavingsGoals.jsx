    ...
    <div className="tab-pane active">
      ...
      <div className="top-header">
        <div className="header-title-area">
          <h1>Bolsillos de Ahorro (Metas)</h1>
          <p>Crea tus propios bolsillos para cumplir tus sueños y metas. ¡Paso a paso, mi reina! 🌸</p>
        </div>
      </div>
        ...
        <div className="glass-card col-span-1" style={{ height: 'fit-content' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div className="form-group">
              <label>Nombre de la Meta / Bolsillo</label>
              <input 
                type="text" 
                value={name} 
                onChange={(e) => setName(e.target.value)} 
                placeholder="Ej. Viaje de Aniversario, Celular..." 
                required 
              />
            </div>
            ...
            <div className="form-group">
              <label>Fecha Objetivo para Cumplirla</label>
              <input 
                type="date" 
                value={targetDate} 
        ...
        <div className="col-span-2" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          {savingsGoals.length === 0 ? (
            <div className="glass-card" style={{ padding: '3rem', textAlign: 'center' }}>
              ...
              <h3>No tienes bolsillos de ahorro activos</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: '0.5rem' }}>Crea tu primera meta a la izquierda y empieza a ahorrar para lo que sueñas. 🍂✨</p>
            </div>
          ) : (
                ...
                <div key={goal.id} className="glass-card" style={{ borderLeft: `5px solid ${progressPct === 100 ? 'var(--accent-emerald)' : 'var(--accent-cyan)'}` }}>
                  ...
                  {remaining === 0 && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--accent-emerald)', fontWeight: 700, fontSize: '0.95rem', backgroundColor: 'rgba(129, 178, 154, 0.08)', padding: '0.6rem 1rem', borderRadius: '8px', width: 'fit-content' }}>
                      ✨ ¡Felicidades! Bolsillo completado con éxito.
                      <button 
                        className="btn btn-secondary" 
